...
let avg =
  (student.scores.chemistry + student.scores.math + student.scores.physics) / 3;
...
let attendanceDay =
  student.attendance.totalDays - student.attendance.absentDays;
let attendanceRate = (attendanceDay / student.attendance.totalDays) * 100;
