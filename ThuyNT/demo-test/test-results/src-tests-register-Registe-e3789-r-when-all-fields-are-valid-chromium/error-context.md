...
- Name: src\tests\register.spec.ts >> Register feature should work correctly >> Should register a new user when all fields are valid
- Location: ThuyNT\demo-test\src\tests\register.spec.ts:22:9
