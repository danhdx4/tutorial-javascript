...
- Name: src\tests\register.spec.ts >> Register feature should work correctly >> Should show required field errors when required fields are empty
- Location: ThuyNT\demo-test\src\tests\register.spec.ts:39:9
