...
- Location: demo test\tests\example.spec.ts:3:5
...
Expected pattern: /Playwright1/
Received string:  "Fast and reliable end-to-end testing for modern web apps | Playwright"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    12 × unexpected value "Fast and reliable end-to-end testing for modern web apps | Playwright"
...
> 7  |   await expect(page).toHaveTitle(/Playwright1/);
     |                      ^ Error: expect(page).toHaveTitle(expected) failed
  8  | });
  9  | 
